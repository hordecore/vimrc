...
autocmd BufNewFile,BufRead *.mail source /usr/share/vim/vimcurrent/ftplugin/mail.vim
autocmd BufNewFile,BufRead *.mail source /usr/share/vim/vimcurrent/syntax/mail.vim
